      ...
      <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl space-y-6">
        ...
        {isSubmitted ? (
          <div className="bg-green-50 border border-green-200 p-4 rounded-2xl text-center space-y-2 text-xs">
            ...
            <p className="text-green-700">Welcome to your account session!</p>
            <button
              onClick={() => setIsSubmitted(false)}
              className="mt-2 text-[#F58220] font-bold underline cursor-pointer"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-[#F58220] hover:bg-[#E06D0F] text-white py-3 rounded-xl font-extrabold text-xs shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
