                  ...
                  <div className="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-6 pt-2 sm:pt-0 border-t sm:border-t-0 border-gray-100">
                    ...
                    <div className="flex items-center border border-gray-200 rounded-xl bg-gray-50 overflow-hidden">
                      <button
                        ...
                        className="p-1.5 text-gray-600 hover:bg-gray-200 cursor-pointer"
                      >
                        <UilMinus size={14} />
                      </button>
          ...
          <div className="bg-white rounded-2xl md:rounded-3xl p-6 border border-gray-100 shadow-xs space-y-4">
            ...
            <form onSubmit={handleApplyPromo} className="space-y-2">
              <div className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="bg-gray-900 hover:bg-black text-white px-4 py-2.5 rounded-xl font-bold text-xs cursor-pointer"
                >
                  Apply
                </button>
              </div>
            ...
            <button
              ...
              className="w-full bg-[#F58220] hover:bg-[#E06D0F] text-white py-3.5 rounded-xl font-extrabold text-sm shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
            ...
            <div className="flex items-center justify-center gap-1.5 text-xs text-gray-400 pt-2">
              <UilShieldCheck size={16} className="text-green-500" /> 100% Secure Checkout
            </div>
          </div>
        </div>
      </div>
