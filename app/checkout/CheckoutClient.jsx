...
import { buttonPressProps, fadeUp } from "@/lib/motion";
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-white rounded-2xl md:rounded-3xl p-6 border border-gray-100 shadow-xs space-y-4">
            ...
            <motion.button
              ...
              className="w-full bg-[#F58220] hover:bg-[#E06D0F] text-white py-4 rounded-xl font-black text-sm shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
              {isSubmitting ? (
                "Processing Order..."
              ) : (
